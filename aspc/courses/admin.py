...
from aspc.courses.models import (Section, GenericSection, Course, Department, Meeting, RequirementArea, RefreshHistory, CourseReview)
...
admin.site.register(GenericSection)
